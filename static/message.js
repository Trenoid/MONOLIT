$(document).ready(function() {
    ...
    const successIcon = staticFiles.data('success-icon');
    const errorIcon = staticFiles.data('error-icon');

    const messageSucceful = `
        <div class="message">
            <div class="message__wrapper">
                <img width="48" height="48" src="${successIcon}" alt="" class="message__image" />
    ...
    const messageError = `
        <div class="message">
            <div class="message__wrapper">
                <img width="48" height="48" src="${errorIcon}" alt="" class="message__image" />
