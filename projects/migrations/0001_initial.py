    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_project', models.DecimalField(decimal_places=0, default=39900, max_digits=10, verbose_name='Цена проекта')),
                ('image', models.ImageField(blank=True, null=True, upload_to='projects_images', verbose_name='Изображение')),
                ('discount', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Скидка в %')),
